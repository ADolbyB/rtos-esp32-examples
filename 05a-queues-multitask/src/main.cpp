...
void blinkLEDTask(void *param)
{
    ...
    for(;;)
    {
        ...
        {
            strcpy(some_msg.body, "Message Received: ");
            some_msg.count = 1;
...
void setup()
{
    ...
    Serial.println("Enter 'delay xxx' where xxx is the");
    Serial.println("new LED blink delay in ms");
